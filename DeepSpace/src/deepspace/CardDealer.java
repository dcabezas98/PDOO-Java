...
class CardDealer {
    ...
    private void createSuppliesPackages() {
        ...
        suppliesPackages.add(new SuppliesPackage(1,10,500));
        suppliesPackages.add(new SuppliesPackage(100,100,100));
        suppliesPackages.add(new SuppliesPackage(100,100,100));
        suppliesPackages.add(new SuppliesPackage(100,100,100));
    }
    ...
    private void createEnemies() {
        ...
        enemies.add(new EnemyStarShip("Enemigo transforma 2",200,100,transformLoot0,regularDamage0));  
        enemies.add(new EnemyStarShip("Enemigo transforma 3",100,200,transformLoot1,regularDamage1));
        enemies.add(new EnemyStarShip("Enemigo transforma 4",200,100,transformLoot0,regularDamage0));  
        enemies.add(new EnemyStarShip("Enemigo transforma 5",100,200,transformLoot1,regularDamage1)); 
        enemies.add(new EnemyStarShip("Enemigo transforma 6",200,100,transformLoot0,regularDamage0));  
        enemies.add(new EnemyStarShip("Enemigo transforma 7",100,200,transformLoot1,regularDamage1)); 
    }
}
